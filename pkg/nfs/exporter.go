...
func (s *NFSExporter) Collect(ch chan<- prometheus.Metric) {
	...
	ch <- prometheus.MustNewConstMetric(nfsServerOpertionsDesc, prometheus.GaugeValue, float64(stats.Nfsstat.Nfsv4.Clientstats.Operations.Setclientidcfrm), "setclientidcfrm")
	...
	ch <- prometheus.MustNewConstMetric(nfsServerOpertionsDesc, prometheus.GaugeValue, float64(stats.Nfsstat.Nfsv4.Clientstats.Operations.Opendwgr), "opendwgr")
	ch <- prometheus.MustNewConstMetric(nfsServerOpertionsDesc, prometheus.GaugeValue, float64(stats.Nfsstat.Nfsv4.Clientstats.Operations.Openattr), "openattr")
	ch <- prometheus.MustNewConstMetric(nfsServerOpertionsDesc, prometheus.GaugeValue, float64(stats.Nfsstat.Nfsv4.Clientstats.Operations.Opencfrm), "opencfrm")
	ch <- prometheus.MustNewConstMetric(nfsServerOpertionsDesc, prometheus.GaugeValue, float64(stats.Nfsstat.Nfsv4.Clientstats.Operations.Delepurge), "delepurge")
	ch <- prometheus.MustNewConstMetric(nfsServerOpertionsDesc, prometheus.GaugeValue, float64(stats.Nfsstat.Nfsv4.Clientstats.Operations.Delreg), "delreg")
	ch <- prometheus.MustNewConstMetric(nfsServerOpertionsDesc, prometheus.GaugeValue, float64(stats.Nfsstat.Nfsv4.Clientstats.Operations.Getfh), "getfh")
